...
def checkCave (chosenCave):
    ...
    time.sleep(2)
    print('Большой дракон выпрыгивает перед вами! Он раскрывает своб пасть ...')
    print()
    time.sleep(2)
    ...
    if chosenCave == str(friendlyCave):
        print('... приветствует Вас и делится своими сокровищами!')
    else:
        print('... и моментально вас съедает!')
